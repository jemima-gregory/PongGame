...
game.out: game.o system.o pio.o timer.o display.o ledmat.o font.o pacer.o tinygl.o navswitch.o led.o ir_uart.o prescale.o timer0.o usart1.o bat.o ball.o comment.o ir_comms.o stage.o
	$(CC) $(CFLAGS) $^ -o $@ -lm
	$(SIZE) $@
